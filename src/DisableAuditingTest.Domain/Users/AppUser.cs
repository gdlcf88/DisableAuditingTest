...
namespace DisableAuditingTest.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DisableAuditingTestDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DisableAuditingTestEfCoreEntityExtensionMappings to extend the IdentityUser entity
